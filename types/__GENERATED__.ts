...
export type ImageFragmentFragment = { permalink?: Maybe<string>, url?: Maybe<string>, width?: Maybe<number>, height?: Maybe<number>, ratio?: Maybe<number>, orientation?: Maybe<string>, focus_css?: Maybe<string>, is_audio?: Maybe<boolean>, is_image?: Maybe<boolean>, is_video?: Maybe<boolean>, size_kb?: Maybe<number> };
...
export type PageDataQuery = { entry?: Maybe<{ title: string, bard?: Maybe<Array<Maybe<{ youtube_id: string, blockType: 'Set_Bard_YoutubeVideo', poster_image: ImageFragmentFragment } | { text?: Maybe<string>, blockType: 'BardText' }>>> }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    PageSlugs(variables?: PageSlugsQueryVariables, requestHeaders?: Headers): Promise<PageSlugsQuery> {
      return withWrapper(() => client.request<PageSlugsQuery>(print(PageSlugsDocument), variables, requestHeaders));
    },
    PageData(variables?: PageDataQueryVariables, requestHeaders?: Headers): Promise<PageDataQuery> {
